  ...
  messages: {
    ...
    sv: {
      message: {
        ...
        calendarOverview: 'Kalenderöversikt',
        weekday: 'Veckodag',
        weekdayOverview: 'Veckodagsöversikt',
        choosePlayer: 'Välj en spelare',
        maxPoints: 'Maxpoäng',
        averagePoints: 'Genomsnittliga poäng',
        minPoints: 'Minpoäng',
        placements: 'Placeringar',
        playerAverages: 'Genomsnittspoäng',
